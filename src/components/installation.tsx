    ...
    <Layout withSidebar>
      <div className={classes.wrapper}>
        ...
        <Box component="section" className={classes.section}>
          <Text size="md">
          DattyUI relies on <a href="https://mantine.dev">Mantine</a> so you
          ...
          <Prism.Tabs defaultValue="NPM">
            <Prism.TabsList>
              <Prism.Tab
                value="NPM"
                icon={<NPMIcon width="1rem" height="1rem" />}
              >
                NPM
              </Prism.Tab>
              <Prism.Tab
                value="Yarn"
                icon={<YarnIcon width="1rem" height="1rem" />}
              >
                Yarn
              </Prism.Tab>
              <Prism.Tab
                value="PNPM"
                icon={<PNPMIcon width="1rem" height="1rem" />}
              >
                PNPM
              </Prism.Tab>
            </Prism.TabsList>
